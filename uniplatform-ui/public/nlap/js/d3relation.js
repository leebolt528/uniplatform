function relationship(links){
    var index = 0;
    var width = 1000,
        height = 450;
    /*var links = [
        {source: "a", target: "b", type: "suit", relation:"挚友"},
        {source: "a", target: "b", type: "suit", relation:"123"},
        {source: "a", target: "b", type: "suit", relation:"卖家"},
        {source: "a", target: "b", type: "suit", relation:"看看"},
    ];*/
    ...
    var path = svg.append("svg:g").selectAll("path")
        ...
        .attr({id: function(d) { return 'mypath'+d.linknum; }, d: 'M50 100Q350 50 350 250Q250 50 50 250'})
    ...
    for(var i=0;i<links.length; i++){
        svg.append('text')
            ...
            .append('textPath')
            //引用路径
            .attr({'xlink:href': '#mypath'+links[i].linknum }).text(links[i].relation)
    }
