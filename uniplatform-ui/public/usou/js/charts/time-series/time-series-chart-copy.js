function timeSeriesChart() {
   ...
   chart.update = function(data1, data2, data3) {
      ...
      //svg.selectAll(".circle"+k).data(change).enter().append("circle").attr("class","circletwo")
      //    .attr("transform","translate("+(padding.left+py)+","+padding.top+")")
      //    .attr("cx",function(d){return xscale(d.xValue); })
      //    .attr("cy",function(d){ return yscale(d.yValue);}).attr("r",2).attr("fill","yellow");
      // 更新折线上的圆点
      ...
      if (data3) {
         ...
         //     .attr("class", "line3")
         //     .attr("d", line(data3));
         path3.transition().duration(250).ease("linear")
                 .attr("d", line(data3));
      ...
      path1.transition().duration(250).ease("linear")
           .attr("d", line(data1));
         
      path2.transition().duration(250).ease("linear")
           .attr("d", line(data2));
