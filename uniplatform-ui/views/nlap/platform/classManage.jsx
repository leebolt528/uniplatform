...
import { Footer,Com_Menu,Chart,convertByteToGbUtil,Chartbar,COMM_HeadBanner,NLPMenu,ClassGroup,Charttree} from '../../../components/uniplatform-ui';
                                ...
                                <div>
                                    <Col size={{ normal: 24, small: 24, medium: 24, large: 24 }} className="filter">
                                        <Input placeholder="请输入要查询的词" type="search"
                                            ...
                                            onClear={this.searchClearClass.bind(this)}>
