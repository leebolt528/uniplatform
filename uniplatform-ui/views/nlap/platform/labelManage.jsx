...
import { Footer,Com_Menu,Chart,convertByteToGbUtil,Chartbar,COMM_HeadBanner,NLPMenu,Charttree} from '../../../components/uniplatform-ui';
...
class LabelManage extends Component{
    ...
    handleEditValue() {
        ...
        const labelEditName = this.getEditValue().replace(/(^\s*)|(\s*$)/g, "");
