                    ...
                    <div key="">
                        ...
                        <div className="dicManage_content">
                            {noData ?
                                ...
                                :
                                <Col>
                                    <Table  striped={true} complex checkable headBolder
                        ...
                        <div className="dicManage_content">
                            <Col size={{ normal: 24, small: 24, medium: 24, large: 24 }} className="cent" style={{height:'156px',zIndex:'1000'}}>
                                {/*<p style={{display:'none'}}><span style={{fontSize:'14px',width:'50%',float:'left',textAlign:'right'}}>类型：</span><span style={{fontSize:'16px',color:'#b67561',float:'left',textAlign:'left'}}>{typeName}</span></p>
                                 <br/>*/}
                                <p><span style={{fontSize:'14px',width:'40%',float:'left',textAlign:'right'}}>类型：</span><span style={{fontSize:'16px',width:'50%',color:'#b67561',float:'left',textAlign:'left'}}>{subTypeName ? subTypeName : ''}</span></p>
                        ...
                        <Modal visible={ addDicVisible } size="middle" onClose={ this.closeAddDicModal.bind( this ) }>
                            ...
                            <ModalBody>
                                ...
                                <FormItem>
                                    ...
                                    <Select dataSource={addType} /*value={dicType}*/ name="dicTypeid" placeholder="请选择词库类别" onChange={this.dicTypeChange.bind(this)} showClear={ false }/>
                                </FormItem>
                                <FormItem disabled={isWrite}>
                                    <Label>词库类型</Label> {/*词库子类型*/}
                                    <Select dataSource={addSubType} name="dicSubTypeId" placeholder="请选择词库类型" trigger={this.formDicTypeTirgger.bind(this)}
